...
//            }
//            sympw.write("SCOPE: ");
//            sympw.write("[id: " + node.id + ", type: " + node.type.type + ", number of parameters: " + node.numParams
//                    + "]\n");
...
//                        errorMessages += "SEMERR: Reuse of id: " + lex + " within scope.\n";
...
//            }
//        }
//        System.out.println(eye.id + "!!!!");
//        errorMessages = errorMessages + "SEMERR: Identifier: " + lex + " is undeclared\n";
//        //pw.write(errorMessages);
//        //pw.flush();
//        return new Type("ERR");
//    }
...
//            current = current.previous;
//        }
//        errorMessages = errorMessages + "SEMERR: Could not find procedure: " + lex + ".\n";
//        return null;
//    }
//
...
//            case PROGRAM:
//			/*
//			 * System.out.println("Program's token is " +
...
//                    if (temp1.attribute == 2 || temp1.attribute == 3 || temp2.attribute == 2 || temp2.attribute == 3) {
//                        errorMessages = errorMessages + "SEMERR: Attempted to use real number to define array length.\n";
//                        // pw.write(errorMessages);
//                        // errorMessages = "";
//                        // pw.flush();
//                    } else if (temp1.attribute == 1 && temp2.attribute == 1) {
//                        arrayLen = Integer.parseInt(temp2.lexeme) - Integer.parseInt(temp1.lexeme) + 1;
//                        flag = true;
//                    } else {
//                        errorMessages = errorMessages + "SEMERR: Unrecognized input for array length.\n";
//                        // pw.write(errorMessages);
//                        // errorMessages = "";
//                        // pw.flush();
//                    }
//                } else if (temp1.token != LEXERR && temp2.token != LEXERR) {
//                    errorMessages = errorMessages + "SEMERR: Use of non-number for array length.\n";
//                    // pw.write(errorMessages);
//                    // errorMessages = "";
//                    // pw.flush();
//                }
//                match(OF);
//                Decoration dec = standard_type();
//                if (flag) {
//                    int width = arrayLen * dec.width;
//                    if (dec.type.type.equals("INT")) {
//                        return new Decoration(new Type("AINT"), width);
//                    } else if (dec.type.type.equals("REAL")) {
//                        return new Decoration(new Type("AREAL"), width);
//                    } else {
//                        errorMessages = errorMessages + "SEMERR: Unexpected type in array declaration.\n";
//                        // pw.write(errorMessages);
//                        // errorMessages = "";
//                        // pw.flush();
...
//                } else {
//                    checkAddBlueNode(temp.lexeme, new Type(dec.type.type), offset);
//                }
...
//        switch (tok.token) {
//            case ID:
//                Decoration dec1 = variable();
//                match(ASSIGNOP);
//                Decoration dec2 = expression();
//                if (!dec1.type.isEquivalent(dec2.type) && !dec1.type.type.equals("ERR") && !dec2.type.type.equals("ERR")) {
//                    errorMessages = errorMessages
//                            + "SEMERR: Attempted to assign variable to expression of different type\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // rrorMessages = "";
//                }
...
//                if (!dec.type.isEquivalent(new Type("BOOL")) && !dec.type.isEquivalent(new Type("ERR"))) {
//                    errorMessages = errorMessages + "SEMERR: Attempted to use non boolean expression in IF statement.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                }
...
//            case WHILE:
//                match(WHILE);
//                Decoration dec3 = expression();
//                if (!dec3.type.isEquivalent(new Type("BOOL")) && !dec3.type.isEquivalent(new Type("ERR"))) {
//                    errorMessages = errorMessages + "SEMERR: Attempted to use non boolean expression in WHILE loop.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                }
...
//                Decoration dec = expression();
//                match(R_BRACK);
//                if (dec.type.type.equals("INT") && (inh.type.type.equals("AINT") || inh.type.type.equals("PP_AINT"))) {
...
//                    return new Decoration(new Type("ERR"), 0);
//                } else {
//                    errorMessages = errorMessages + "SEMERR: Incorrect array access.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                    return new Decoration(new Type("ERR"), 0);
...
//                } else {
//                    errorMessages = errorMessages + "SEMERR: " + temp.lexeme + " is not a procedure.\n";
//                    procedure_statement_tail(null);
//                }
//
//                break;
...
//                } else {
//                    int params = expression_list(inh.numParams, inh.content);
//                    if (params != 0) {
//                        errorMessages = errorMessages + "SEMERR: Incorrect number of parameters in procedure call.\n";
//                        // pw.write(errorMessages);
//                        // pw.flush();
//                        // errorMessages = "";
//                    }
...
//                } else if (!dec.type.isEquivalent(inh.type) && !dec.type.type.equals("ERR")) {
//                    errorMessages = errorMessages + "SEMERR: Parameter type mismatch.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                }
...
//            default:
//                if (tok.token != LEXERR && !tok_reported) {
//                    errorMessages = errorMessages + "SYNERR: Expected ID, NUM, L_PAREN, NOT, ADDOP (e) received: "
//                            + token_defs[tok.token][0] + "\n";
//                    tok_reported = true;
//                }
...
//                    return new Decoration(new Type("BOOL"), 0);
//                } else if (dec.type.type.equals("ERR") || inh.type.type.equals("ERR")) {
//                    return new Decoration(new Type("ERR"), 0);
//                } else {
//                    errorMessages = errorMessages + "SEMERR: Non bool type used for relop operation.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                    return new Decoration(new Type("ERR"), 0);
...
//            case ADDOP:
//                sign();
//                Decoration dec2 = term();
//                if (!dec2.type.type.equals("INT") && !dec2.type.type.equals("REAL")) {
//                    errorMessages = errorMessages + "SEMERR: Attempted to sign unsignable time.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                    dec2 = new Decoration(new Type("ERR"), 0);
//                }
//                return simple_expression_tail(dec2);
//            default:
//                if (tok.token != LEXERR && !tok_reported) {
//                    errorMessages = errorMessages + "SYNERR: Expected ID, NUM, L_PAREN, NOT, ADDOP (se) received: "
//                            + token_defs[tok.token][0] + "\n";
//                    tok_reported = true;
//                }
...
//                        return new Decoration(new Type("ERR"), 0);
//                    } else {
//                        errorMessages = errorMessages + "SEMERR: Incompatible types in addop operation.\n";
//                        // pw.write(errorMessages);
//                        // pw.flush();
//                        // errorMessages = "";
//                        return new Decoration(new Type("ERR"), 0);
...
//                        return new Decoration(new Type("ERR"), 0);
//                    } else {
//                        errorMessages = errorMessages + "SEMERR: Incompatible types in OR operation.\n";
//                        // pw.write(errorMessages);
//                        // pw.flush();
//                        // errorMessages = "";
//                        return new Decoration(new Type("ERR"), 0);
//                    }
//                } else {
//                    errorMessages = errorMessages + "SEMERR: Invalid ADDOP.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                    return new Decoration(new Type("ERR"), 0);
...
//                            return new Decoration(new Type("ERR"), 0);
//                        } else {
//                            errorMessages = errorMessages + "SEMERR: Incompatible types in multiplication operation.\n";
//                            // pw.write(errorMessages);
//                            // pw.flush();
//                            // errorMessages = "";
//                            return new Decoration(new Type("ERR"), 0);
...
//                            return new Decoration(new Type("ERR"), 0);
//                        } else {
//                            errorMessages = errorMessages + "SEMERR: Incompatible types in div operation.\n";
//                            // pw.write(errorMessages);
//                            // pw.flush();
//                            // errorMessages = "";
//                            return new Decoration(new Type("ERR"), 0);
...
//                            return new Decoration(new Type("ERR"), 0);
//                        } else {
//                            errorMessages = errorMessages + "SEMERR: Incompatible types in mod operation.\n";
//                            // pw.write(errorMessages);
//                            // pw.flush();
//                            // errorMessages = "";
//                            return new Decoration(new Type("ERR"), 0);
...
//                            return new Decoration(new Type("ERR"), 0);
//                        } else {
//                            errorMessages = errorMessages + "SEMERR: Incompatible types in AND operation.\n";
//                            // pw.write(errorMessages);
//                            // pw.flush();
//                            // errorMessages = "";
//                            return new Decoration(new Type("ERR"), 0);
//                        }
//                    default:
//                        errorMessages = errorMessages + "SEMERR: Invalid MULOP.\n";
//                        // pw.write(errorMessages);
//                        // pw.flush();
//                        // errorMessages = "";
//                        return new Decoration(new Type("ERR"), 0);
...
//                match(ID);
//                Type type = getType(temp.lexeme);
//                return factor_tail(new Decoration(type, 0));
//            case NUM:
//                Decoration dec;
//                if (tok.attribute == 1) {
...
//            case NOT:
//                match(NOT);
//                Decoration dec3 = factor();
//                if (dec3.type.type.equals("BOOL") || dec3.type.type.equals("ERR")) {
//                    return dec3;
//                } else {
//                    errorMessages = errorMessages + "SEMERR: NOT used within non-boolean expression.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                    return new Decoration(new Type("ERR"), 0);
...
//                Decoration dec = expression();
//                match(R_BRACK);
//                if (dec.type.type.equals("INT") && inh.type.type.equals("AINT")) {
//                    return new Decoration(new Type("INT"), 0);
//                } else if (dec.type.type.equals("INT") && inh.type.type.equals("AREAL")) {
//                    return new Decoration(new Type("REAL"), 0);
//                } else if (!inh.type.type.equals("AINT") && !inh.type.type.equals("AREAL")
//                        && !inh.type.type.equals("ERR")) {
//                    errorMessages = errorMessages + "SEMERR: Attempted array access of non-array object.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                    return new Decoration(new Type("ERR"), 0);
//                } else if (!dec.type.type.equals("INT") && !dec.type.type.equals("ERR")) {
//                    errorMessages = errorMessages + "SEMERR: Attempted array index with non integer.\n";
//                    // pw.write(errorMessages);
//                    // pw.flush();
//                    // errorMessages = "";
//                    return new Decoration(new Type("ERR"), 0);
...
//                b_p = f_p;
//                return new Token(lex, 99, 2); // LEXERR, LONG ID
//            }
//            String lex = new String(c_buffer).substring(b_p, f_p);
//            b_p = f_p;
...
//
//    public ColoredNode node;
//    public SymbolStack previous;
//
//    public SymbolStack() {
//
//    }
...
//    public int width;
//
//    public Decoration (Type t, int w) {
//        type = t;
//        width = w;
//    }
//
